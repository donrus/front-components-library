useEffect(() => {
   ...
   */
  const elem = document.querySelector('.site-content');

  const startScreenWidth = 1920;
  const startScreenHeight = 980;

  const startObjectWidth = 1520;
  const startObjectHeight = 855;
