...
export default class EsSlickSlider{
    constructor(){
        this.init();
    }
    init(){
        ...
        rev.on('init', function(event, slick, currentSlide) {
            ...
            slick.$prev = prev;
            slick.$next = next;
            cur.removeClass('slick-next').removeClass('3Dlick-sprev');
        });
        ...
        rev.slick({
            ...
            dots: false,
            focusOnSelect: true,
            prevArrow: '<button class="es-slick-slider__prev-button"></button>',
            nextArrow: '<button class="es-slick-slider__next-button"></button>',
            infinite: true,
            centerMode: true,
            slidesPerRow: 1,
            slidesToShow: 1,
