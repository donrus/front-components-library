...
(function($) {
  ...
  SECTIONS_ARRAY.push(document.querySelector('.first-screen-container'));
  SECTIONS_ARRAY.push(document.querySelector('.promo-mechanic'));
  SECTIONS_ARRAY.push(document.querySelector('.promo-prizes'));
  SECTIONS_ARRAY.push(document.querySelector('.last-screen-container'));
  ...
  function scrollUp(section) {
    if (section.classList.contains('promo-mechanic')) {
      cssAnimation(parallaxSection, 'show-up').then(() => {
        parallaxSection.className = parallaxSection.className.replace(/hide-up/g, '');
        parallaxSection.className = parallaxSection.className.replace(/show-up/g, '');
      });
    }
  ...
  function scrollDown(section) {
    if (section.classList.contains('promo-mechanic')) {
      cssAnimation(parallaxSection, 'hide-up');
    }
  ...
  if (!isMobileDevice()) {
    ...
    for (let i = 0; i < SECTIONS_ARRAY.length; i++) {
      SECTIONS_ARRAY[i].classList.remove('position-fixed', 'display-none');
    }
