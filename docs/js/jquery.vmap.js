...
JQVMap.prototype.positionPins = function () {
  ...
  jQuery.each(pins, function (index, pinObj) {
    ...
    var coords = {
      ...
      top: rootCoords.top - mapCoords.top - 19,
    };
    ...
    var deltaX =
      (bbox.width * scale * parseInt(pinObj.attr('deltaX'), 10)) / 100;
    var deltaY =
      (bbox.height * scale * parseInt(pinObj.attr('deltaY'), 10)) / 100;
    
    pinObj.css({
      // left: coords.left + middleX - pinObj.width() / 2 + deltaX,
      // top: coords.top + middleY - pinObj.height() / 2 + deltaY,
      left: coords.left + middleX + deltaX,
      top: coords.top + middleY + deltaY,
    });
  });
};
